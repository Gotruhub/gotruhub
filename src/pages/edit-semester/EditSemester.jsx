                ...
                <div className="flex items-center flex-col justify-center gap-5 px-5 max-w-[500px] mx-auto">
                    ...
                    <div className='w-full flex flex-col gap-7'>
                        <div>
                            ...
                            <input value={name} type="text" onChange={e => setName(e.target.value)}  placeholder='First Term' className='w-full border border-[#25751E] rounded-[6px] py-3 px-5 bg-[#25751E26] outline-none'  />
